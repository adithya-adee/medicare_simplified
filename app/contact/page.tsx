...
export const metadata = {
  title: 'Contact Us | Medicare Simplified',
  description: 'Get in touch with our team for support or inquiries about Medicare Simplified products and services.',
};
    ...
    <div className="container mx-auto py-12 px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Have a question or need assistance? Our team is here to help you. Fill out the form below or reach out directly.
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600">
                <span className="font-medium">Email:</span> support@medicaresimplified.com
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-1">123 Healthcare Avenue</p>
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm border p-6">
          <div className="divide-y">
            <div className="py-4">
              ...
              <p className="text-gray-600">We offer standard (3-5 business days), express (1-2 business days), and same-day delivery options depending on your location.</p>
            </div>
            <div className="py-4">
            ...
            <div className="py-4">
              ...
              <p className="text-gray-600">We accept returns within 30 days of delivery for most items. Please ensure the product is in its original condition with all packaging.</p>
            </div>
            <div className="py-4">
              <h3 className="font-medium mb-2">Do you offer international shipping?</h3>
              <p className="text-gray-600">Yes, we ship to selected countries internationally. Shipping costs and delivery times vary by location.</p>
            </div>
          </div>
